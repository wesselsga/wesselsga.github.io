...
6. Change the C++ runtime to use static CRT (/MT) rather than the default (/MD).  
...
6. Verify our x265 build with pkg-config
  ...
  * Navigate to **C:\x265\lib**.  The INSTALL step for x265 named the output lib **x265-static.lib**, rename it to **x265.lib**
